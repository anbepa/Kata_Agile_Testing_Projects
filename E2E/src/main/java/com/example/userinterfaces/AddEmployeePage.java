...
public class AddEmployeePage {
        ...
        /** Input for the employee ID. */
        public static final Target EMPLOYEE_ID_FIELD = Target.the("employee id field")
                        .located(By.xpath("//label[text()='Employee Id']/parent::div/parent::div//input"));
